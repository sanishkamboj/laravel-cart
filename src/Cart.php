...
class Cart
{
	...
	public function __construct()
	{
        ...
        $this->_cart_contents = !empty($_SESSION['cart_contents']) ? $_SESSION['cart_contents'] : NULL;
	...
	public function contents($newest_first = FALSE)
	{
        ...
        if(isset($_SESSION['cart_contents'])){
            $cart = ($newest_first) ? array_reverse($_SESSION['cart_contents']) : $_SESSION['cart_contents'];
